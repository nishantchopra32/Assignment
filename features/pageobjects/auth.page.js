class AuthPage {
    ...
    createAccount = async (emailId, address) => {
      ...
      await this.input_Password.setValue("password421");
  
      // DOB
      await this.drpbx_Days.selectByIndex(12);
      await this.drpbx_Months.selectByAttribute("value", "3");
      await this.drpbx_Years.selectByAttribute("value", "1929");
      ...
      await this.input_PostalCode.setValue("12345");
      await this.txt_AdditionalInfo.setValue(
        "Additional Information added "
      );
      await this.input_Phone.setValue("12345678");
      await this.input_MobilePhone.setValue("+42 2345678");
      await this.input_AddressAlias.setValue("New Address");
